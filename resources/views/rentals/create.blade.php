    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('rentals.store') }}" method="POST">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="datetime-local" class="form-control @error('rental_date') is-invalid @enderror" 
                                   id="rental_date" name="rental_date" value="{{ old('rental_date', now()->format('Y-m-d\TH:i')) }}" required>
                            @error('rental_date')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('inventory_id') is-invalid @enderror" 
                                   id="inventory_id" name="inventory_id" value="{{ old('inventory_id') }}" required>
                            @error('inventory_id')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('staff_id') is-invalid @enderror" 
                                   id="staff_id" name="staff_id" value="{{ old('staff_id', 1) }}" required>
                            @error('staff_id')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="d-flex">
                    <button type="submit" class="btn btn-primary me-2">Guardar Renta</button>
