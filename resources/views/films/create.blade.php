    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('films.store') }}" method="POST">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('language_id') is-invalid @enderror" 
                                   id="language_id" name="language_id" value="{{ old('language_id', 1) }}" required>
                            @error('language_id')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('length') is-invalid @enderror" 
                                   id="length" name="length" value="{{ old('length') }}" min="1">
                            @error('length')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('rental_rate') is-invalid @enderror" 
                                   id="rental_rate" name="rental_rate" value="{{ old('rental_rate', '2.99') }}" 
                                   min="0" required>
                            @error('rental_rate')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('rating') is-invalid @enderror" id="rating" name="rating">
                                ...
                                <option value="PG-13" {{ old('rating') == 'PG-13' ? 'selected' : '' }}>PG-13 - Parental Guidance 13+</option>
                                <option value="R" {{ old('rating') == 'R' ? 'selected' : '' }}>R - Restricted</option>
                                <option value="NC-17" {{ old('rating') == 'NC-17' ? 'selected' : '' }}>NC-17 - No Children 17-</option>
                            </select>
                            @error('rating')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('special_features') is-invalid @enderror" 
                                      ...
                                      placeholder="Ej: Comentarios del director, Escenas eliminadas">{{ old('special_features') }}</textarea>
                ...
                <div class="d-flex">
                    <button type="submit" class="btn btn-primary me-2">Guardar Película</button>
